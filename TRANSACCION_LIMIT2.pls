CREATE OR REPLACE PROCEDURE TRANSACCION_LIMIT2 AS 
...
BEGIN
       ...
       -----------------        
          ...
          --Calcula una nueva cantidad con la que se está comprando en base al nuevo precio de la moneda de compra
           ...
           --Verifíca si la nueva cantidad de monedas aun existe dentro de la cartera    
            IF  (nueva_cantidad_moneda) > cantidad_cartera_1
            THEN 
            NULL;
            END IF;
           ...
           --Moneda que se está comprando
            ...
            VALUES
            (1,fecha,datosm(precio_moneda1/precio_moneda2*cantidad_ventacompra,nuevo_precio_moneda),id_cartera2,id_monedamercado);
            ...
            VALUES
            (2,fecha,datosm(nueva_cantidad_moneda,precio_moneda1),id_cartera1,moneda_id,id_transaccion);
         ------------------   
 ...
 -------------------------------------------------------------------------------------------------------------------------       
        ...
        -----------------  
            --Calcula un nuevo precio en dolares para la moneda a comprar           
            SELECT dbms_random.value(precio_moneda1/2,precio_moneda1*2)
            INTO nuevo_precio_moneda
            FROM dual;  
            
            --Calcula una nueva cantidad con la que se está comprando en base al nuevo precio de la moneda de compra
            nueva_cantidad_moneda := (nuevo_precio_moneda/precio_moneda2)*(cantidad_ventacompra);
            
            --Verifíca si la nueva cantidad de monedas aun existe dentro de la cartera    
            IF  (nueva_cantidad_moneda) > cantidad_cartera_2
            THEN 
            NULL;
            END IF;
            ...
            (tipo,fecha,datos_monedas,id_cartera,id_moneda)
            VALUES
            (2,fecha,datosm(nueva_cantidad_moneda,precio_moneda2),id_cartera2,id_monedamercado);
            ...
            (tipo,fecha,datos_monedas,id_cartera,id_moneda,numero_transaccion_asociada)
            VALUES
            (1,fecha,datosm(cantidad_ventacompra,nuevo_precio_moneda),id_cartera1,moneda_id,id_transaccion);
